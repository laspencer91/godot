...
- RUNNING: Codex implementing Phase 4 per CSG-PHASE4-PLAN.md. On completion: review diff → Opus /simplify → verify (all four filters + new scheduler/domain cases + counter pins) → commit → Phase 5 (extrusion) planning.
