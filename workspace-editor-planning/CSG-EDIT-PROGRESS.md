...
- NEXT: Phase 6 (surface materials + planar UVs + Paint tool) planning → Codex → simplify → verify → commit. Phase 6 prompt must include the get_material() virtual on CSGPrimitive3D (deferred decision) + the EditorNode-edited-root capture note.
