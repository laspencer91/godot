...
| 5 | Shift-drag box extrusion | PLANNING (Opus) |
...
- RUNNING: Codex implementing Phase 5 per CSG-PHASE5-PLAN.md (modules/csg/** + tests/editor/** only). On completion: review → simplify → verify → commit → Phase 6 (materials/UVs/Paint) planning.
