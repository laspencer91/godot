...
void EditorComponentTheme::populate(const Ref<EditorTheme> &p_theme, const EditorThemeManager::ThemeConfiguration &p_config) {
	...
	const Color divider_fill = p_config.surface_base_color.lerp(p_config.accent_color, p_config.dark_theme ? 0.080 : 0.050);
	const Color subsection_fill = p_config.surface_base_color.lerp(p_config.surface_high_color, p_config.dark_theme ? 0.070 : 0.045);
	...
	p_theme->set_color("divider_start", "InspectorChromeHeaderPreview", divider_fill);
	p_theme->set_color("divider_end", "InspectorChromeHeaderPreview", divider_fill);
	p_theme->set_color("subsection_start", "InspectorChromeHeaderPreview", subsection_fill);
	p_theme->set_color("subsection_end", "InspectorChromeHeaderPreview", subsection_fill);
	...
	p_theme->set_color("divider_font_color", "InspectorChromeHeaderPreview", p_config.font_color.lerp(p_config.accent_color, p_config.dark_theme ? 0.12 : 0.08));
	p_theme->set_color("subsection_font_color", "InspectorChromeHeaderPreview", p_config.font_secondary_color.lerp(p_config.font_color, 0.52));
	...
	p_theme->set_constant("divider_height", "InspectorChromeHeaderPreview", 25 * EDSCALE);
	p_theme->set_constant("section_height", "InspectorChromeHeaderPreview", 29 * EDSCALE);
	p_theme->set_constant("subsection_height", "InspectorChromeHeaderPreview", 25 * EDSCALE);
