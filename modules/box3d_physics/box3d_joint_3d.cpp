...
Box3DJoint3D::Box3DJoint3D() {
	pin_params[PhysicsServer3D::PIN_JOINT_BIAS] = 0.3;
	pin_params[PhysicsServer3D::PIN_JOINT_DAMPING] = 1.0;
	pin_params[PhysicsServer3D::PIN_JOINT_IMPULSE_CLAMP] = 0.0;

	hinge_params[PhysicsServer3D::HINGE_JOINT_BIAS] = HINGE_DEFAULT_BIAS;
	hinge_params[PhysicsServer3D::HINGE_JOINT_LIMIT_UPPER] = 0.0;
	hinge_params[PhysicsServer3D::HINGE_JOINT_LIMIT_LOWER] = 0.0;
	hinge_params[PhysicsServer3D::HINGE_JOINT_LIMIT_BIAS] = HINGE_DEFAULT_LIMIT_BIAS;
	hinge_params[PhysicsServer3D::HINGE_JOINT_LIMIT_SOFTNESS] = HINGE_DEFAULT_SOFTNESS;
	hinge_params[PhysicsServer3D::HINGE_JOINT_LIMIT_RELAXATION] = HINGE_DEFAULT_RELAXATION;
	hinge_params[PhysicsServer3D::HINGE_JOINT_MOTOR_TARGET_VELOCITY] = 0.0;
	hinge_params[PhysicsServer3D::HINGE_JOINT_MOTOR_MAX_IMPULSE] = 0.0;

	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_UPPER] = 0.0;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_LOWER] = 0.0;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_SOFTNESS] = SLIDER_DEFAULT_LINEAR_LIMIT_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_RESTITUTION] = SLIDER_DEFAULT_LINEAR_LIMIT_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_DAMPING] = SLIDER_DEFAULT_LINEAR_LIMIT_DAMPING;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_MOTION_SOFTNESS] = SLIDER_DEFAULT_LINEAR_MOTION_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_MOTION_RESTITUTION] = SLIDER_DEFAULT_LINEAR_MOTION_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_MOTION_DAMPING] = SLIDER_DEFAULT_LINEAR_MOTION_DAMPING;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_ORTHOGONAL_SOFTNESS] = SLIDER_DEFAULT_LINEAR_ORTHO_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_ORTHOGONAL_RESTITUTION] = SLIDER_DEFAULT_LINEAR_ORTHO_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_ORTHOGONAL_DAMPING] = SLIDER_DEFAULT_LINEAR_ORTHO_DAMPING;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_UPPER] = SLIDER_DEFAULT_ANGULAR_LIMIT;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_LOWER] = SLIDER_DEFAULT_ANGULAR_LIMIT;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_SOFTNESS] = SLIDER_DEFAULT_ANGULAR_LIMIT_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_RESTITUTION] = SLIDER_DEFAULT_ANGULAR_LIMIT_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_DAMPING] = SLIDER_DEFAULT_ANGULAR_LIMIT_DAMPING;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_MOTION_SOFTNESS] = SLIDER_DEFAULT_ANGULAR_MOTION_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_MOTION_RESTITUTION] = SLIDER_DEFAULT_ANGULAR_MOTION_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_MOTION_DAMPING] = SLIDER_DEFAULT_ANGULAR_MOTION_DAMPING;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_ORTHOGONAL_SOFTNESS] = SLIDER_DEFAULT_ANGULAR_ORTHO_SOFTNESS;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_ORTHOGONAL_RESTITUTION] = SLIDER_DEFAULT_ANGULAR_ORTHO_RESTITUTION;
	slider_params[PhysicsServer3D::SLIDER_JOINT_ANGULAR_ORTHOGONAL_DAMPING] = SLIDER_DEFAULT_ANGULAR_ORTHO_DAMPING;

	cone_params[PhysicsServer3D::CONE_TWIST_JOINT_SWING_SPAN] = 0.0;
	cone_params[PhysicsServer3D::CONE_TWIST_JOINT_TWIST_SPAN] = 0.0;
	cone_params[PhysicsServer3D::CONE_TWIST_JOINT_BIAS] = CONE_TWIST_DEFAULT_BIAS;
	cone_params[PhysicsServer3D::CONE_TWIST_JOINT_SOFTNESS] = CONE_TWIST_DEFAULT_SOFTNESS;
	cone_params[PhysicsServer3D::CONE_TWIST_JOINT_RELAXATION] = CONE_TWIST_DEFAULT_RELAXATION;
}
...
bool Box3DJoint3D::_can_build() const {
	if (type == PhysicsServer3D::JOINT_TYPE_MAX || body_a == nullptr || body_b == nullptr) {
		return false;
	}
...
b3JointId Box3DJoint3D::_create_slider() {
	...
	def.lowerTranslation = (float)slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_LOWER];
	def.upperTranslation = (float)slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_UPPER];
...
b3JointId Box3DJoint3D::_create_generic_6dof() {
	...
	for (int axis = 0; axis < 3; axis++) {
		for (int flag = 0; flag < PhysicsServer3D::G6DOF_JOINT_FLAG_MAX; flag++) {
			any_constraint_enabled = any_constraint_enabled || g6dof_flags[axis][flag];
		}
		linear_locked[axis] = g6dof_flags[axis][PhysicsServer3D::G6DOF_JOINT_FLAG_ENABLE_LINEAR_LIMIT] &&
				_limit_locks(g6dof_params[axis][PhysicsServer3D::G6DOF_JOINT_LINEAR_LOWER_LIMIT], g6dof_params[axis][PhysicsServer3D::G6DOF_JOINT_LINEAR_UPPER_LIMIT]);
		angular_locked[axis] = g6dof_flags[axis][PhysicsServer3D::G6DOF_JOINT_FLAG_ENABLE_ANGULAR_LIMIT] &&
				_limit_locks(g6dof_params[axis][PhysicsServer3D::G6DOF_JOINT_ANGULAR_LOWER_LIMIT], g6dof_params[axis][PhysicsServer3D::G6DOF_JOINT_ANGULAR_UPPER_LIMIT]);
	...
	if (all_linear_locked) {
		...
		if (has_cone_limits) {
			const real_t y = MAX(Math::abs(g6dof_params[Vector3::AXIS_Y][PhysicsServer3D::G6DOF_JOINT_ANGULAR_LOWER_LIMIT]), Math::abs(g6dof_params[Vector3::AXIS_Y][PhysicsServer3D::G6DOF_JOINT_ANGULAR_UPPER_LIMIT]));
			const real_t z = MAX(Math::abs(g6dof_params[Vector3::AXIS_Z][PhysicsServer3D::G6DOF_JOINT_ANGULAR_LOWER_LIMIT]), Math::abs(g6dof_params[Vector3::AXIS_Z][PhysicsServer3D::G6DOF_JOINT_ANGULAR_UPPER_LIMIT]));
			def.enableConeLimit = true;
...
void Box3DJoint3D::clear() {
	...
	type = PhysicsServer3D::JOINT_TYPE_MAX;
...
void Box3DJoint3D::pin_set_param(PhysicsServer3D::PinJointParam p_param, real_t p_value) {
...
real_t Box3DJoint3D::pin_get_param(PhysicsServer3D::PinJointParam p_param) const {
...
void Box3DJoint3D::hinge_set_param(PhysicsServer3D::HingeJointParam p_param, real_t p_value) {
	ERR_FAIL_INDEX(p_param, PhysicsServer3D::HINGE_JOINT_MAX);
...
real_t Box3DJoint3D::hinge_get_param(PhysicsServer3D::HingeJointParam p_param) const {
	ERR_FAIL_INDEX_V(p_param, PhysicsServer3D::HINGE_JOINT_MAX, 0.0);
	return hinge_params[p_param];
}

void Box3DJoint3D::hinge_set_flag(PhysicsServer3D::HingeJointFlag p_flag, bool p_enabled) {
	ERR_FAIL_INDEX(p_flag, PhysicsServer3D::HINGE_JOINT_FLAG_MAX);
...
bool Box3DJoint3D::hinge_get_flag(PhysicsServer3D::HingeJointFlag p_flag) const {
	ERR_FAIL_INDEX_V(p_flag, PhysicsServer3D::HINGE_JOINT_FLAG_MAX, false);
	return hinge_flags[p_flag];
}

void Box3DJoint3D::slider_set_param(PhysicsServer3D::SliderJointParam p_param, real_t p_value) {
	ERR_FAIL_INDEX(p_param, PhysicsServer3D::SLIDER_JOINT_MAX);
	slider_params[p_param] = p_value;
	if (p_param == PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_LOWER || p_param == PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_UPPER) {
		if (B3_IS_NON_NULL(joint_id)) {
			b3PrismaticJoint_SetLimits(joint_id, (float)slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_LOWER], (float)slider_params[PhysicsServer3D::SLIDER_JOINT_LINEAR_LIMIT_UPPER]);
		}
	} else if (p_param >= PhysicsServer3D::SLIDER_JOINT_ANGULAR_LIMIT_UPPER) {
		WARN_PRINT_ONCE("Box3D: SliderJoint angular parameters are not supported and will be ignored.");
	}
}

real_t Box3DJoint3D::slider_get_param(PhysicsServer3D::SliderJointParam p_param) const {
	ERR_FAIL_INDEX_V(p_param, PhysicsServer3D::SLIDER_JOINT_MAX, 0.0);
	return slider_params[p_param];
}

void Box3DJoint3D::cone_twist_set_param(PhysicsServer3D::ConeTwistJointParam p_param, real_t p_value) {
	ERR_FAIL_INDEX(p_param, PhysicsServer3D::CONE_TWIST_MAX);
	cone_params[p_param] = p_value;
	if (p_param == PhysicsServer3D::CONE_TWIST_JOINT_SWING_SPAN || p_param == PhysicsServer3D::CONE_TWIST_JOINT_TWIST_SPAN) {
		if (type == PhysicsServer3D::JOINT_TYPE_CONE_TWIST) {
			rebuild();
		}
	} else {
...
real_t Box3DJoint3D::cone_twist_get_param(PhysicsServer3D::ConeTwistJointParam p_param) const {
	ERR_FAIL_INDEX_V(p_param, PhysicsServer3D::CONE_TWIST_MAX, 0.0);
	return cone_params[p_param];
}

void Box3DJoint3D::generic_6dof_set_param(Vector3::Axis p_axis, PhysicsServer3D::G6DOFJointAxisParam p_param, real_t p_value) {
	ERR_FAIL_INDEX(p_axis, 3);
	ERR_FAIL_INDEX(p_param, PhysicsServer3D::G6DOF_JOINT_MAX);
	g6dof_params[p_axis][p_param] = p_value;
	if (type == PhysicsServer3D::JOINT_TYPE_6DOF) {
		rebuild();
	}
}

real_t Box3DJoint3D::generic_6dof_get_param(Vector3::Axis p_axis, PhysicsServer3D::G6DOFJointAxisParam p_param) const {
	ERR_FAIL_INDEX_V(p_axis, 3, 0.0);
	ERR_FAIL_INDEX_V(p_param, PhysicsServer3D::G6DOF_JOINT_MAX, 0.0);
	return g6dof_params[p_axis][p_param];
}

void Box3DJoint3D::generic_6dof_set_flag(Vector3::Axis p_axis, PhysicsServer3D::G6DOFJointAxisFlag p_flag, bool p_enabled) {
	ERR_FAIL_INDEX(p_axis, 3);
	ERR_FAIL_INDEX(p_flag, PhysicsServer3D::G6DOF_JOINT_FLAG_MAX);
...
bool Box3DJoint3D::generic_6dof_get_flag(Vector3::Axis p_axis, PhysicsServer3D::G6DOFJointAxisFlag p_flag) const {
	ERR_FAIL_INDEX_V(p_axis, 3, false);
	ERR_FAIL_INDEX_V(p_flag, PhysicsServer3D::G6DOF_JOINT_FLAG_MAX, false);
